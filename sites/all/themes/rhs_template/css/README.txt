...
To use these stylesheets, rename the files and rhs_template with the name of your theme.
...
rhs_template-alpha-default.css
...
rhs_template-alpha-default-narrow.css  
...
rhs_template-alpha-default-normal.css
...
rhs_template-alpha-default-wide.css
